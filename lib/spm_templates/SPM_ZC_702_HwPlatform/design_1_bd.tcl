...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.C_M_AXI_DATA_WIDTH {32} CONFIG.DATA_SIZE_AVG {16}  ] $atg_gp0
  ...
  set_property -dict [ list CONFIG.ENABLE_ADVANCED_OPTIONS {1} CONFIG.M00_HAS_REGSLICE {1} CONFIG.M01_HAS_REGSLICE {1} CONFIG.M02_HAS_REGSLICE {1} CONFIG.M03_HAS_REGSLICE {1} CONFIG.M04_HAS_REGSLICE {1} CONFIG.M05_HAS_REGSLICE {1} CONFIG.M06_HAS_REGSLICE {1} CONFIG.M07_HAS_REGSLICE {1} CONFIG.M08_HAS_REGSLICE {1} CONFIG.M09_HAS_REGSLICE {1} CONFIG.NUM_MI {11} CONFIG.NUM_SI {1} CONFIG.S00_HAS_REGSLICE {1} CONFIG.S01_HAS_REGSLICE {1} CONFIG.S02_HAS_REGSLICE {1} CONFIG.STRATEGY {1}  ] $axi_mem_intercon
  ...
  # Create instance: axi_mem_intercon_6, and set properties
  set axi_mem_intercon_6 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 axi_mem_intercon_6 ]
  set_property -dict [ list CONFIG.NUM_MI {1}  ] $axi_mem_intercon_6
...
CONFIG.PCW_EN_CAN0 {1} CONFIG.PCW_EN_CLK0_PORT {1} \
...
CONFIG.PCW_I2C_RESET_POLARITY {Active Low} CONFIG.PCW_MIO_0_IOTYPE {LVCMOS 1.8V} \
...
CONFIG.PCW_MIO_16_IOTYPE {HSTL 1.8V} CONFIG.PCW_MIO_16_PULLUP {enabled} \
...
CONFIG.PCW_MIO_18_IOTYPE {HSTL 1.8V} CONFIG.PCW_MIO_18_PULLUP {enabled} \
...
CONFIG.PCW_MIO_21_IOTYPE {HSTL 1.8V} CONFIG.PCW_MIO_21_PULLUP {enabled} \
...
CONFIG.PCW_MIO_23_IOTYPE {HSTL 1.8V} CONFIG.PCW_MIO_23_PULLUP {enabled} \
...
CONFIG.PCW_MIO_25_IOTYPE {HSTL 1.8V} CONFIG.PCW_MIO_25_PULLUP {enabled} \
...
CONFIG.PCW_MIO_27_IOTYPE {HSTL 1.8V} CONFIG.PCW_MIO_27_PULLUP {enabled} \
...
CONFIG.PCW_QSPI_PERIPHERAL_CLKSRC {ARM PLL} CONFIG.PCW_QSPI_PERIPHERAL_ENABLE {1} \
...
CONFIG.PCW_SPI_PERIPHERAL_CLKSRC {IO PLL} CONFIG.PCW_S_AXI_ACP_FREQMHZ {100} \
CONFIG.PCW_S_AXI_HP0_DATA_WIDTH {64} CONFIG.PCW_S_AXI_HP0_FREQMHZ {100} \
CONFIG.PCW_S_AXI_HP1_DATA_WIDTH {64} CONFIG.PCW_S_AXI_HP1_FREQMHZ {100} \
CONFIG.PCW_S_AXI_HP2_DATA_WIDTH {64} CONFIG.PCW_S_AXI_HP2_FREQMHZ {100} \
CONFIG.PCW_S_AXI_HP3_DATA_WIDTH {64} CONFIG.PCW_S_AXI_HP3_FREQMHZ {100} \
...
CONFIG.PCW_USE_S_AXI_ACP {1} CONFIG.PCW_USE_S_AXI_GP0 {1} \
...
CONFIG.PCW_WDT_PERIPHERAL_ENABLE {0}  ] $processing_system7_1
  ...
  connect_bd_intf_net -intf_net atg_gp0_M_AXI [get_bd_intf_pins atg_gp0/M_AXI] [get_bd_intf_pins axi_mem_intercon_6/S00_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets atg_gp0_M_AXI] [get_bd_intf_pins atg_gp0/M_AXI] [get_bd_intf_pins xilmonitor_apm/SLOT_5_AXI]
  connect_bd_intf_net -intf_net atg_hp0_m_axi [get_bd_intf_pins atg_hp0/M_AXI] [get_bd_intf_pins axi_mem_intercon_2/S00_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets atg_hp0_m_axi] [get_bd_intf_pins atg_hp0/M_AXI] [get_bd_intf_pins xilmonitor_apm/SLOT_0_AXI]
  ...
  connect_bd_intf_net -intf_net axi_mem_intercon_6_M00_AXI [get_bd_intf_pins axi_mem_intercon_6/M00_AXI] [get_bd_intf_pins processing_system7_1/S_AXI_GP0]
  ...
  connect_bd_intf_net -intf_net axi_mem_intercon_M10_AXI [get_bd_intf_pins atg_gp0/S_AXI] [get_bd_intf_pins axi_mem_intercon/M10_AXI]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_traffic_gen_1_axi_master] [get_bd_intf_pins atg_acp/M_AXI] [get_bd_intf_pins xilmonitor_apm/SLOT_4_AXI]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_traffic_gen_3_axi_master] [get_bd_intf_pins atg_hp1/M_AXI] [get_bd_intf_pins xilmonitor_apm/SLOT_1_AXI]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_traffic_gen_4_axi_master] [get_bd_intf_pins atg_hp2/M_AXI] [get_bd_intf_pins xilmonitor_apm/SLOT_2_AXI]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_traffic_gen_5_axi_master] [get_bd_intf_pins atg_hp3/M_AXI] [get_bd_intf_pins xilmonitor_apm/SLOT_3_AXI]
  ...
  connect_bd_net -net clk [get_bd_pins atg_acp/s_axi_aclk] [get_bd_pins atg_gp0/s_axi_aclk] [get_bd_pins atg_hp0/s_axi_aclk] [get_bd_pins atg_hp1/s_axi_aclk] [get_bd_pins atg_hp2/s_axi_aclk] [get_bd_pins atg_hp3/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/M01_ACLK] [get_bd_pins axi_mem_intercon/M02_ACLK] [get_bd_pins axi_mem_intercon/M03_ACLK] [get_bd_pins axi_mem_intercon/M04_ACLK] [get_bd_pins axi_mem_intercon/M05_ACLK] [get_bd_pins axi_mem_intercon/M06_ACLK] [get_bd_pins axi_mem_intercon/M07_ACLK] [get_bd_pins axi_mem_intercon/M08_ACLK] [get_bd_pins axi_mem_intercon/M09_ACLK] [get_bd_pins axi_mem_intercon/M10_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon_1/ACLK] [get_bd_pins axi_mem_intercon_1/M00_ACLK] [get_bd_pins axi_mem_intercon_1/S00_ACLK] [get_bd_pins axi_mem_intercon_2/ACLK] [get_bd_pins axi_mem_intercon_2/M00_ACLK] [get_bd_pins axi_mem_intercon_2/S00_ACLK] [get_bd_pins axi_mem_intercon_3/ACLK] [get_bd_pins axi_mem_intercon_3/M00_ACLK] [get_bd_pins axi_mem_intercon_3/S00_ACLK] [get_bd_pins axi_mem_intercon_4/ACLK] [get_bd_pins axi_mem_intercon_4/M00_ACLK] [get_bd_pins axi_mem_intercon_4/S00_ACLK] [get_bd_pins axi_mem_intercon_5/ACLK] [get_bd_pins axi_mem_intercon_5/M00_ACLK] [get_bd_pins axi_mem_intercon_5/S00_ACLK] [get_bd_pins axi_mem_intercon_6/ACLK] [get_bd_pins axi_mem_intercon_6/M00_ACLK] [get_bd_pins axi_mem_intercon_6/S00_ACLK] [get_bd_pins proc_sys_reset/slowest_sync_clk] [get_bd_pins processing_system7_1/FCLK_CLK0] [get_bd_pins processing_system7_1/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_1/S_AXI_ACP_ACLK] [get_bd_pins processing_system7_1/S_AXI_GP0_ACLK] [get_bd_pins processing_system7_1/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_1/S_AXI_HP1_ACLK] [get_bd_pins processing_system7_1/S_AXI_HP2_ACLK] [get_bd_pins processing_system7_1/S_AXI_HP3_ACLK] [get_bd_pins xilmonitor_apm/core_aclk] [get_bd_pins xilmonitor_apm/m_axis_aclk] [get_bd_pins xilmonitor_apm/s_axi_aclk] [get_bd_pins xilmonitor_apm/slot_0_axi_aclk] [get_bd_pins xilmonitor_apm/slot_1_axi_aclk] [get_bd_pins xilmonitor_apm/slot_2_axi_aclk] [get_bd_pins xilmonitor_apm/slot_3_axi_aclk] [get_bd_pins xilmonitor_apm/slot_4_axi_aclk] [get_bd_pins xilmonitor_apm/slot_5_axi_aclk] [get_bd_pins xilmonitor_broadcast/aclk] [get_bd_pins xilmonitor_fifo0/s_axi_aclk] [get_bd_pins xilmonitor_fifo1/s_axi_aclk] [get_bd_pins xilmonitor_fifo2/s_axi_aclk] [get_bd_pins xilmonitor_subset0/aclk] [get_bd_pins xilmonitor_subset1/aclk] [get_bd_pins xilmonitor_subset2/aclk]
  ...
  connect_bd_net -net peripheral_resetn [get_bd_pins atg_acp/s_axi_aresetn] [get_bd_pins atg_gp0/s_axi_aresetn] [get_bd_pins atg_hp0/s_axi_aresetn] [get_bd_pins atg_hp1/s_axi_aresetn] [get_bd_pins atg_hp2/s_axi_aresetn] [get_bd_pins atg_hp3/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/M01_ARESETN] [get_bd_pins axi_mem_intercon/M02_ARESETN] [get_bd_pins axi_mem_intercon/M03_ARESETN] [get_bd_pins axi_mem_intercon/M04_ARESETN] [get_bd_pins axi_mem_intercon/M05_ARESETN] [get_bd_pins axi_mem_intercon/M06_ARESETN] [get_bd_pins axi_mem_intercon/M07_ARESETN] [get_bd_pins axi_mem_intercon/M08_ARESETN] [get_bd_pins axi_mem_intercon/M09_ARESETN] [get_bd_pins axi_mem_intercon/M10_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon_1/M00_ARESETN] [get_bd_pins axi_mem_intercon_1/S00_ARESETN] [get_bd_pins axi_mem_intercon_2/M00_ARESETN] [get_bd_pins axi_mem_intercon_2/S00_ARESETN] [get_bd_pins axi_mem_intercon_3/M00_ARESETN] [get_bd_pins axi_mem_intercon_3/S00_ARESETN] [get_bd_pins axi_mem_intercon_4/M00_ARESETN] [get_bd_pins axi_mem_intercon_4/S00_ARESETN] [get_bd_pins axi_mem_intercon_5/M00_ARESETN] [get_bd_pins axi_mem_intercon_5/S00_ARESETN] [get_bd_pins axi_mem_intercon_6/ARESETN] [get_bd_pins axi_mem_intercon_6/M00_ARESETN] [get_bd_pins axi_mem_intercon_6/S00_ARESETN] [get_bd_pins proc_sys_reset/peripheral_aresetn] [get_bd_pins xilmonitor_apm/core_aresetn] [get_bd_pins xilmonitor_apm/m_axis_aresetn] [get_bd_pins xilmonitor_apm/s_axi_aresetn] [get_bd_pins xilmonitor_apm/slot_0_axi_aresetn] [get_bd_pins xilmonitor_apm/slot_1_axi_aresetn] [get_bd_pins xilmonitor_apm/slot_2_axi_aresetn] [get_bd_pins xilmonitor_apm/slot_3_axi_aresetn] [get_bd_pins xilmonitor_apm/slot_4_axi_aresetn] [get_bd_pins xilmonitor_apm/slot_5_axi_aresetn] [get_bd_pins xilmonitor_broadcast/aresetn] [get_bd_pins xilmonitor_fifo0/s_axi_aresetn] [get_bd_pins xilmonitor_fifo1/s_axi_aresetn] [get_bd_pins xilmonitor_fifo2/s_axi_aresetn] [get_bd_pins xilmonitor_subset0/aresetn] [get_bd_pins xilmonitor_subset1/aresetn] [get_bd_pins xilmonitor_subset2/aresetn]
  ...
  create_bd_addr_seg -range 0x40000000 -offset 0x0 [get_bd_addr_spaces atg_gp0/Data] [get_bd_addr_segs processing_system7_1/S_AXI_GP0/GP0_DDR_LOWOCM] SEG_processing_system7_1_GP0_DDR_LOWOCM
  create_bd_addr_seg -range 0x400000 -offset 0xE0000000 [get_bd_addr_spaces atg_gp0/Data] [get_bd_addr_segs processing_system7_1/S_AXI_GP0/GP0_IOP] SEG_processing_system7_1_GP0_IOP
  create_bd_addr_seg -range 0x40000000 -offset 0x40000000 [get_bd_addr_spaces atg_gp0/Data] [get_bd_addr_segs processing_system7_1/S_AXI_GP0/GP0_M_AXI_GP0] SEG_processing_system7_1_GP0_M_AXI_GP0
  create_bd_addr_seg -range 0x1000000 -offset 0xFC000000 [get_bd_addr_spaces atg_gp0/Data] [get_bd_addr_segs processing_system7_1/S_AXI_GP0/GP0_QSPI_LINEAR] SEG_processing_system7_1_GP0_QSPI_LINEAR
  ...
  create_bd_addr_seg -range 0x800000 -offset 0x4C000000 [get_bd_addr_spaces processing_system7_1/Data] [get_bd_addr_segs atg_gp0/S_AXI/Reg0] SEG_atg_gp0_Reg0
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x46000000 [get_bd_addr_spaces processing_system7_1/Data] [get_bd_addr_segs axi_gpio_0/S_AXI/MYREG0] SEG_axi_gpio_0_MYREG0
...
#  -string -flagsOSRD
preplace port DDR -pg 1 -y 2050 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 2070 -defaultsOSRD
preplace inst xilmonitor_fifo2 -pg 1 -lvl 7 -y 1660 -defaultsOSRD
preplace inst processing_system7_1 -pg 1 -lvl 5 -y 2100 -defaultsOSRD
preplace inst atg_hp1 -pg 1 -lvl 3 -y 1800 -defaultsOSRD
preplace inst atg_hp2 -pg 1 -lvl 3 -y 1640 -defaultsOSRD
preplace inst atg_acp -pg 1 -lvl 3 -y 1500 -defaultsOSRD
preplace inst axi_mem_intercon_1 -pg 1 -lvl 4 -y 1580 -defaultsOSRD
preplace inst atg_hp3 -pg 1 -lvl 3 -y 1960 -defaultsOSRD
preplace inst atg_gp0 -pg 1 -lvl 3 -y 2100 -defaultsOSRD
preplace inst axi_mem_intercon_2 -pg 1 -lvl 4 -y 2770 -defaultsOSRD
preplace inst axi_mem_intercon_3 -pg 1 -lvl 4 -y 2310 -defaultsOSRD
preplace inst xilmonitor_apm -pg 1 -lvl 4 -y 720 -defaultsOSRD
preplace inst axi_mem_intercon_4 -pg 1 -lvl 4 -y 1820 -defaultsOSRD
preplace inst axi_gpio_0 -pg 1 -lvl 3 -y 2270 -defaultsOSRD
preplace inst xilmonitor_subset0 -pg 1 -lvl 6 -y 1820 -defaultsOSRD
preplace inst axi_mem_intercon_5 -pg 1 -lvl 4 -y 2060 -defaultsOSRD
preplace inst xilmonitor_subset1 -pg 1 -lvl 6 -y 1380 -defaultsOSRD
preplace inst xilmonitor_broadcast -pg 1 -lvl 5 -y 1560 -defaultsOSRD
preplace inst axi_mem_intercon_6 -pg 1 -lvl 4 -y 2550 -defaultsOSRD
preplace inst xilmonitor_subset2 -pg 1 -lvl 6 -y 1700 -defaultsOSRD
preplace inst xilmonitor_fifo0 -pg 1 -lvl 7 -y 1920 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 2 -y 1840 -defaultsOSRD
preplace inst xilmonitor_fifo1 -pg 1 -lvl 7 -y 1480 -defaultsOSRD
preplace inst proc_sys_reset -pg 1 -lvl 1 -y 2100 -defaultsOSRD
preplace inst atg_hp0 -pg 1 -lvl 3 -y 2420 -defaultsOSRD
preplace netloc xilmonitor_apm_M_AXIS 1 4 1 1510
preplace netloc processing_system7_1_ddr 1 5 3 NJ 2050 NJ 2050 NJ
preplace netloc processing_system7_1_M_AXI_GP0 1 1 5 390 2190 NJ 2190 NJ 2190 NJ 2310 1950
preplace netloc axi_mem_intercon_m02_axi 1 2 1 720
preplace netloc axi_mem_intercon_M10_AXI 1 2 1 710
preplace netloc axi_mem_intercon_5_m00_axi 1 4 1 1460
preplace netloc processing_system7_1_FCLK_RESET0_N 1 0 6 20 2500 NJ 2500 NJ 2500 NJ 2430 NJ 2430 1940
preplace netloc axi_mem_intercon_m01_axi 1 2 1 780
preplace netloc axi_mem_intercon_m00_axi 1 2 1 730
preplace netloc xilmonitor_broadcast_M00_AXIS 1 5 1 1950
preplace netloc axi_mem_intercon_M06_AXI 1 2 5 720 2180 NJ 1940 NJ 1890 NJ 1890 NJ
preplace netloc xilmonitor_subset0_M_AXIS 1 6 1 2230
preplace netloc axi_traffic_gen_4_axi_master 1 3 1 1090
preplace netloc axi_mem_intercon_M09_AXI 1 2 1 700
preplace netloc axi_mem_intercon_M05_AXI 1 2 2 690 40 NJ
preplace netloc atg_gp0_M_AXI 1 3 1 1130
preplace netloc xilmonitor_broadcast_M02_AXIS 1 5 1 1940
preplace netloc peripheral_resetn 1 1 6 360 1520 750 2520 1140 1460 1520 1460 1970 1510 2240
preplace netloc xilmonitor_broadcast_M01_AXIS 1 5 1 1940
preplace netloc processing_system7_1_fixed_io 1 5 3 NJ 2070 NJ 2070 NJ
preplace netloc axi_mem_intercon_2_m00_axi 1 4 1 1520
preplace netloc xilmonitor_subset1_M_AXIS 1 6 1 2260
preplace netloc axi_mem_intercon_M08_AXI 1 2 5 770 1720 NJ 1700 NJ 1630 NJ 1630 NJ
preplace netloc axi_mem_intercon_6_M00_AXI 1 4 1 1510
preplace netloc axi_mem_intercon_1_m00_axi 1 4 1 1480
preplace netloc axi_gpio_0_gpio_io_o 1 2 2 790 2340 1050
preplace netloc axi_mem_intercon_m03_axi 1 2 1 760
preplace netloc axi_mem_intercon_M07_AXI 1 2 5 N 1880 NJ 1450 NJ 1450 NJ 1450 NJ
preplace netloc interconnect_resetn 1 1 3 380 2160 NJ 2200 1150
preplace netloc xilmonitor_subset2_M_AXIS 1 6 1 2250
preplace netloc axi_traffic_gen_5_axi_master 1 3 1 1100
preplace netloc axi_mem_intercon_3_m00_axi 1 4 1 1480
preplace netloc axi_traffic_gen_1_axi_master 1 3 1 1150
preplace netloc axi_mem_intercon_m04_axi 1 2 1 700
preplace netloc axi_mem_intercon_4_m00_axi 1 4 1 1470
preplace netloc atg_hp0_m_axi 1 3 1 1060
preplace netloc clk 1 0 7 20 2010 370 1510 740 2510 1120 2180 1500 1490 1960 1490 2260
preplace netloc axi_traffic_gen_3_axi_master 1 3 1 1080
levelinfo -pg 1 0 190 540 920 1310 1730 2100 2420 2600 -top 0 -bot 2890
",
}
